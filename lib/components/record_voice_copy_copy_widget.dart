...
import 'record_voice_copy_copy_model.dart';
export 'record_voice_copy_copy_model.dart';

class RecordVoiceCopyCopyWidget extends StatefulWidget {
  const RecordVoiceCopyCopyWidget({
    super.key,
  ...
  @override
  State<RecordVoiceCopyCopyWidget> createState() =>
      _RecordVoiceCopyCopyWidgetState();
}

class _RecordVoiceCopyCopyWidgetState extends State<RecordVoiceCopyCopyWidget>
    with TickerProviderStateMixin {
  late RecordVoiceCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecordVoiceCopyCopyModel());
                            ...
                            SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (selectedFiles != null) {
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_localuploadx =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedFiles.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_localuploadx =
                                                  selectedUploadedFiles.first;
                                              _model.uploadedFileUrl_localuploadx =
                                                  downloadUrls.first;
                                            });
                                          } else {
                                            safeSetState(() {});
                                              ...
                                              child: ExpandableNotifier(
                                                ...
                                                child: ExpandablePanel(
                                                  ...
                                                  collapsed: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        'Click  Above to view script to record audio',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                  ...
                                  if (containerRecordingsRow?.fileUrl != null &&
